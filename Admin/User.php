...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <tr>
          <td height="27" bgcolor="#A0B9F3"><strong>Tạo mới User</strong></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="25" bgcolor="#A0B9F3"><strong>DS User</strong></td>
        </tr>
        <tr>
          <td>
...
<td class="style3"><div align="left" class="style9 style5"><strong><a href="DeleteUser.php?UserId=<?php echo $Id;?>">Xóa</a></strong></div></td>
</tr>
<?php
}
