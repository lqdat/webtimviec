    ...
    <div id="page" class="box">
        <div id="page-in" class="box">
            ...
            <div id="content">
                ...
                <!-- Article -->
                <div class="article">
                    <h2><span><a href="#">Welcome admin</a></span></h2>


                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td height="27" bgcolor="#A0B9F3"><span class="style4 style10">Tạo tin tức</span></td>
                        </tr>
                        <tr>
                            <td height="26">
                                <form id="form1" method="post" action="InsertNews.php">
                                    <table width="100%" height="109" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td height="36"><span class="style9">Tin tức:</span></td>
                              ...
                              <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                                        ...
                                        <tr>
                                            <td height="35"><span class="style9">Ngày:</span></td>
                        ...
                        <tr>
                            <td height="25" bgcolor="#A0B9F3"><span class="style3">DS tin tức</span></td>
                        </tr>
                        <tr>
                            <td>
                                <table width="100%" border="1" bordercolor="#1CB5F1">
                                    <tr>
                                        ...
                                        <th bgcolor="#1CB5F1">
                                            <div align="left" class="style11 style7 style8">Tin tức</div>
                                        </th>
                                        <th bgcolor="#1CB5F1">
                                            <div align="left" class="style11 style7 style8">Ngày</div>
                                        </th>
                                        <th height="32" bgcolor="#1CB5F1">
                                            <div align="left" class="style11 style7 style8">Edit</div>
                                        </th>
                                        <th bgcolor="#1CB5F1">
                                            <div align="left" class="style11 style7 style8">Xóa</div>
                                        </th>
                                    </tr>
                                    <?php
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div align="left" class="style11 style7 style8"><a
                                                        href="DeleteNews.php?NewsId=<?php echo $Id; ?>">Xóa</a></div>
                                            </td>
                                        </tr>
                                        <?php
                                    }
