                                ...
                                <table width="100%" border="1" bordercolor="#1CB5F1">
                                    <tr>
                                        ...
                                        <th bgcolor="#1CB5F1" class="style3">
                                            <div align="left" class="style9 style5"><strong>Tên công ty</strong></div>
                                        </th>
                                        <th bgcolor="#1CB5F1" class="style3">
                                            <div align="left" class="style9 style5"><strong>Thành phố</strong></div>
                                        </th>
                                        <th bgcolor="#1CB5F1" class="style3">
                                            <div align="left" class="style12">Người liên hệ</div>
                                        </th>
                                        <th bgcolor="#1CB5F1" class="style3">
                                            <div align="left" class="style9 style5"><strong>Chi tiết</strong></div>
                                        </th>
                                    </tr>
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td class="style3">
                                                <div align="left" class="style9 style5"><strong><a
                                                            href="DetailEmp.php?EmpId=<?php echo $Id; ?>">Chi tiết</a></strong>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php
