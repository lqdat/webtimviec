...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Thông tin Phỏng vấn</a></span></h2>
...
?>
                <table width="100%" border="1" bordercolor="#1CB5F1" >
                  ...
                  <th width="26%" height="32" bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Tên Công ty</strong>:</div></th>
