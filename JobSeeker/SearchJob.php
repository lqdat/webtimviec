...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Tìm việc</a></span></h2>
               

                <form id="form1" method="post" action="SearchJob.php">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><strong>Chọn Trình độ:</strong></td>
                      <td><label>
...
?>
                    ...
                    <tr>
                      <td><strong>Chọn công ty:</strong></td>
                      <td><label>
...
?>
                    ...
                    <tr>
                      <td><strong>Chọn công việc:</strong></td>
                      <td><label>
...
?>
                  ...
                  <tr>
                    <td width="100%">&nbsp;
						...
						do { ?>
                          ...
                          <tr>
                          <td><strong>ID Công việc</strong></td>
                          ...
                          <tr>
                          <td><strong>Số lượng tuyển</strong></td>
                          ...
                          <td><strong><?php echo $row_Recordset2['Description']; ?></strong></td>
                           ...
                           <tr>
                             <td>&nbsp;</td>
                             <td><a href="Apply.php?JobId=<?php echo $row_Recordset2['JobId'];?>"><strong>Apply Công việc</strong></a></td>
                           </tr>
                        </table>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td bgcolor="#A0B9F3"><strong>Trạng thái Công việc</strong></td>
                  </tr>
                  <tr>
                    <td><table width="100%" border="1" cellpadding="1" cellspacing="2" bordercolor="#006699" >
                      <tr>
                        <th height="32" bgcolor="#006699" class="style3"><div align="left" class="style9 style5 style2"><strong>Tên Công ty</strong></div></th>
                        <th bgcolor="#006699" class="style3"><div align="left" class="style9 style5 style2"><strong>Tiêu đề</strong></div></th>
                        <th bgcolor="#006699" class="style3"><div align="left" class="style9 style5 style2"><strong>Trạng thái</strong></div></th>
