...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Trình độ chuyên môn  </a></span></h2>
               

              <table width="100%" border="1" cellspacing="2" cellpadding="2">
                  <tr>
                    <td bgcolor="#A0B9F3"><strong>Tạo profile </strong></td>
                  </tr>
                  <tr>
                    <td><form id="form1" method="post" action="InsertEdu.php">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td><strong>Chuyên ngành khác:</strong></td>
                          <td><label>
                  ...
                  <tr>
                    <td bgcolor="#A0B9F3"><strong>Thông tin </strong></td>
                  </tr>
                  <tr>
                    <td><table width="100%" border="1" cellpadding="1" cellspacing="2" bordercolor="#006699" >
                      <tr>
                        <th height="32" bgcolor="#006699" class="style3"><div align="left" class="style9 style5 style2"><strong>Chuyên Ngành</strong></div></th>
                        <th bgcolor="#006699" class="style3"><div align="left" class="style9 style5 style2"><strong>trường</strong></div></th>
                        <th bgcolor="#006699" class="style3"><div align="left" class="style9 style5 style2"><strong>Năm tốt nghiệp</strong></div></th>
                         <th bgcolor="#006699" class="style3"><div align="left" class="style9 style5 style2"><strong>Phần trăm</strong></div></th>
                      </tr>
                      <?php
					  $ID=$_SESSION['ID'];
