...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Welcome Home</a></span></h2>
                ...
                <table width="100%" border="0">
                  ...
                  <tr>
                    <td bgcolor="#A0B9F3"><div align="center"><a href="index.php"><strong>Trang chủ</strong></a></div></td>
                    <td bgcolor="#A0B9F3"><div align="center"><a href="Profile.php"><strong>Profile</strong></a></div></td>
					<td bgcolor="#A0B9F3"><div align="center"><a href="ManageJob.php"><strong>Quản lý việc</strong></a></div></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td bgcolor="#A0B9F3"><div align="center"><a href="ManageWalkin.php"><strong>Phỏng vấn</strong></a></div></td>
                    <td bgcolor="#A0B9F3"><div align="center"><a href="Application.php"><strong>Apply</strong></a></div></td>
                    <td bgcolor="#A0B9F3"><div align="center"><a href="logout.php"><strong>Đăng xuất</strong></a></div></td>
                  </tr>
                </table>
                <p>&nbsp;</p>
