        ...
        <div id="content">
          ...
          <div class="article">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td bgcolor="#A0B9F3"><strong>Quản lý việc</strong></td>
              </tr>
              <tr>
                <td>
                  ...
                  <table width="100%" border="1" bordercolor="#1CB5F1">
                    <tr>
                      ...
                      <th bgcolor="#1CB5F1" class="style3">
                        <div align="left" class="style9 style5"><strong>Tên công việc</strong></div>
                      </th>
                      <th bgcolor="#1CB5F1" class="style3">
                        <div align="left" class="style9 style5"><strong>Số lượng</strong></div>
                      </th>
                      <th bgcolor="#1CB5F1" class="style3">
                        <div align="left" class="style9 style5"><strong>Trình độ</strong></div>
                      </th>
                      <th bgcolor="#1CB5F1" class="style3">
                        <div align="left" class="style9 style5"><strong>Công việc</strong></div>
                      </th>

                      <th bgcolor="#1CB5F1" class="style3">
                        <div align="left" class="style12">Xóa</div>
                      </th>
                    </tr>
                    <?php
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="style3">
                          <div align="left" class="style9 style5"><strong><a href="DeleteJob.php?JobId=<?php echo $Id; ?>">Xóa</a></strong></div>
                        </td>
                      </tr>
                    <?php
                    }
